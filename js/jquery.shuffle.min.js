...
// Used for unique instance variables
     ...
     */
    Shuffle.EventType = {
        LOADING: 'loading', DONE: 'done', LAYOUT: 'layout', REMOVED: 'removed'
    };


    /** @enum {string} */
    Shuffle.ClassName = {
        BASE: SHUFFLE, SHUFFLE_ITEM: 'shuffle-item', FILTERED: 'filtered', CONCEALED: 'concealed'
    };
...
// Expose for testing.
    ...
    Shuffle.prototype._getFilteredSets = function (category, $items) {
        ...
        return {
            filtered: $filtered, concealed: $concealed
        };
    };
    ...
    Shuffle.prototype._doesPassFilter = function (category, $item) {
        if ($.isFunction(category)) {
            ...
            var keys = this.delimeter && !$.isArray(groups) ? groups.split(this.delimeter) : groups;
    ...
    Shuffle.prototype._initItems = function ($items) {
        ...
        $items.addClass([Shuffle.ClassName.SHUFFLE_ITEM, Shuffle.ClassName.FILTERED].join(' '));
    ...
    Shuffle.prototype._layoutItem = function (item, isOnlyPosition) {
        ...
        var itemSize = {
            width: Shuffle._getOuterWidth(item, true), height: Shuffle._getOuterHeight(item, true)
        };
    ...
    Shuffle.prototype._getItemPosition = function (itemSize) {
        ...
        // Position the item
        var point = new Point(Math.round(this.colWidth * shortColumnIndex), Math.round(setY[shortColumnIndex]));
    ...
    Shuffle.prototype._shrink = function ($collection) {
        ...
        each($concealed, function (item) {
            ...
            this.styleQueue.push({
                $item: $item, point: itemData.point, scale: CONCEALED_SCALE, opacity: 0, callback: function () {
                    $item.css('visibility', 'hidden');
                }
            });
        }, this);
    ...
    Shuffle.prototype._revealAppended = function (newFilteredItems) {
        defer(function () {
            each(newFilteredItems, function (el) {
                var $item = $(el);
                this._transition({
                    $item: $item, opacity: 1, point: $item.data('point'), scale: DEFAULT_SCALE
                });
            }, this);
    ...
    Shuffle.prototype.destroy = function () {
        ...
        this.$items
            ...
            .removeData('point')
            .removeData('scale')
            .removeClass([Shuffle.ClassName.CONCEALED, Shuffle.ClassName.FILTERED, Shuffle.ClassName.SHUFFLE_ITEM].join(' '));
